...
export default function School() {
  ...
  return (
    <div data-ui-polish="batch-204" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={GraduationCap}
        eyebrow="SkySchool AI · Learning-assist preview"
        title="Explore AI learning concepts without fabricating a model or outcome."
        description="Explore local AI-assisted learning concepts with search, category filters, learning-path and assessment intent, model/provider, prompt, privacy, safety, instructor, accessibility, and safeguarding gates, save/reset, and blocked enrollment/certificate actions. No model, provider, course, instructor, learner, enrollment, progress, grade, rating, price, earnings, or certificate is connected."
        badge="Evidence-bounded SkySchool AI workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="AI education evidence boundary">
          <strong>
            This is a local AI-learning design preview, not evidence that a
            ...
            <CardContent className="p-6">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search local AI-learning concepts"
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">
                  No AI education evidence loaded
                </p>
                <p className="mt-2 text-sm text-slate-500">
                  Connect an approved model/provider, governed curriculum,
                  instructor authorization, course access, learner privacy,
                  accessibility, safeguarding, assessment, progress persistence,
                  appeals, certificate rules, and support before enrolling.
                </p>
              </div>
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              AI learning-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real SkySchool AI-learning system must prove
            </h2>
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "SkySchool AI surface preserved",
              description:
                "AI-assisted learning concepts, filters, learning paths, assessments, instructors, model/provider boundaries, enroll, start, submit, certificates, save/reset, and gates remain interactive.",
              icon: GraduationCap,
              status: "Local AI learning",
            },
            {
