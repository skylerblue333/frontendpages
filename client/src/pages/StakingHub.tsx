...
export default function StakingDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={Coins}
        eyebrow="Staking hub · Protocol readiness preview"
        title="Review staking protocols without inventing yield, rewards, or participation."
        ...
        badge="Evidence-bounded staking hub workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Staking hub evidence boundary">
          <strong>
            This is a read-only staking-hub design preview, not evidence that a
        ...
        <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <Card className="border-white/10 bg-white/[0.04]">
            <CardContent className="p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-violet-200">
                Selected protocol readiness
              </p>
              <h2 className="mt-2 text-2xl font-black">
                No live protocol position loaded
              </h2>
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">
                  No staking-hub evidence loaded
                </p>
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Staking-hub governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real staking hub must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Staking hub surface preserved",
              description:
            ...
            {
              title: "Evidence before protocol transaction",
              description:
