  ...
  return (
    <div data-ui-polish="batch-204" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        ...
        title="Explore measurement states without inventing audience or performance data."
        ...
        badge="Evidence-bounded social analytics workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Social measurement evidence boundary">
          <strong>
            This is a local analytics-design preview, not evidence that a
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Analytics-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real social analytics surface must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Analytics surface preserved",
              description:
