...
export default function SocialAnalytics() {
  ...
  return (
    <div data-ui-polish="batch-205" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={FileText}
        eyebrow="Social feed V2 · Community stream preview"
        title="Evaluate feed V2 states without inventing live community activity."
        description="Explore a local social-measurement workspace with channel concepts, date-range intent, audience, content, sentiment, provenance, privacy, save/reset, and blocked collection, insight, and export actions. No platform account, audience, metric, sentiment, conversion, revenue, or business outcome is connected."
        badge="Evidence-bounded Social Feed V2 workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Social Feed V2 evidence boundary">
          <strong>
            This is a local social-feed design preview, not evidence that a
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_0.8fr]">
              <label className="text-sm font-semibold text-slate-300">
                <span className="flex items-center gap-2">
                  ...
                  Search Social Feed V2 concepts
                </span>
                <input
                  value={query}
          ...
          <Card className="border-white/10 bg-white/[0.04]">
            <CardContent className="p-6">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-violet-200">
                    Selected Social Feed V2 concept
                  </p>
                  <h2 className="mt-2 text-2xl font-black">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">
                  No Social Feed V2 evidence loaded
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-500">
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Social Feed V2 governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real Social Feed V2 surface must prove
            </h2>
