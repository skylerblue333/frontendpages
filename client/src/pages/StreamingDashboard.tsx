...
export default function SocialEvents() {
  ...
  return (
    ...
    >
      <ScreenHero
        icon={CalendarDays}
        eyebrow="Streaming dashboard · Broadcast readiness preview"
        title="Review stream states without claiming a broadcast or audience exists."
        description="Explore a local streaming workspace with broadcast, creator, media, viewer, moderation, schedule, delivery, privacy, save/reset, and blocked start, ingest, publish, monetize, and reporting actions. No stream, creator, viewer, media asset, watch time, ad, subscription, revenue, or audience outcome is connected."
        badge="Evidence-bounded streaming workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Streaming evidence boundary">
          <strong>
            This is a local streaming-design preview, not evidence that an
            event, organizer, attendee, schedule, venue, ticket, payment,
            reminder, attendance, or community outcome exists.
          </strong>{" "}
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Streaming-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real streaming surface must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Streaming surface preserved",
              description:
            ...
            {
              title: "Evidence before broadcasting",
              description:
