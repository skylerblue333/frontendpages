...
export default function SupportTicket() {
  ...
  return (
    <div className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={Ticket}
        eyebrow="Support ticket · Case-readiness preview"
        title="Design a support request without claiming it was submitted or resolved."
        description="Review a local support-case workspace with requester identity, category, severity, privacy, attachments, routing, SLA, status, escalation, accessibility, save/reset, and blocked submit, attach, escalate, and close actions. No ticket, agent assignment, response, SLA, resolution, refund, account change, or customer outcome is connected."
        badge="Evidence-bounded support workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Support-case evidence boundary">
          <strong>
            This is a local support-case design preview, not evidence that a
            ticket was created, routed, read, answered, escalated, refunded,
            resolved, or closed.
          </strong>{" "}
          Category, severity, saved state, privacy prompts, and disabled
          submit/attach actions are browser concepts. No requester, message,
          ...
          <Card className="border-white/10 bg-white/[0.04]">
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">No support evidence loaded</p>
                <p className="mt-2 text-sm leading-6 text-slate-500">
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            ...
            <h2 className="mt-2 text-2xl font-black">
              What a real case system must prove
            </h2>
