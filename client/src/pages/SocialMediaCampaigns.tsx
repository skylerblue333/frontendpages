...
export default function SocialAnalytics() {
  ...
  return (
    <div className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={FileText}
        eyebrow="Social campaigns · Planning preview"
        title="Plan campaign states without inventing delivery, spend, or performance."
        description="Explore a local campaign-planning workspace with platform and creative concepts, audience and schedule intent, consent, policy review, budget, attribution, provenance, privacy, save/reset, and blocked connect, publish, schedule, spend, and reporting actions. No campaign, delivery, budget, conversion, revenue, or performance outcome is connected."
        badge="Evidence-bounded campaign workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Campaign evidence boundary">
          <strong>
            This is a local campaign-design preview, not evidence that a
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Campaign-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real campaign surface must prove
            </h2>
