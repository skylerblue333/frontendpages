...
export default function School() {
  ...
  return (
    <div className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={GraduationCap}
        eyebrow="SkySchool · Learning ecosystem preview"
        title="Make SkySchool useful without claiming learning outcomes."
        description="Explore local SkySchool foundations, technology, AI, and community SkySchool course concepts with search, category filters, learning-path and assessment intent, instructor, privacy, accessibility, and safeguarding gates, save/reset, and blocked enrollment/certificate actions. No course, instructor, learner, enrollment, progress, grade, rating, price, earnings, or certificate is connected."
        badge="Evidence-bounded SkySchool workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Education evidence boundary">
          <strong>
            This is a local learning-design preview, not evidence that a course,
            instructor, learner, enrollment, grade, certificate, price, or
            earnings outcome exists.
          </strong>{" "}
            ...
            <CardContent className="p-6">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search local SkySchool learning concepts"
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-violet-200">
                    Selected SkySchool course concept
                  </p>
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Learning-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real SkySchool learning system must prove
            </h2>
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Education surface preserved",
              description:
