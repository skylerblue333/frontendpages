...
export default function Notifications() {
  ...
  const [status, setStatus] = useState(
    "Notifications Center is unavailable locally. No events, recipients, preferences, read states, or notification records were loaded or saved."
  );
            ...
            <div>
              <div className="flex flex-wrap gap-2">
                <Badge variant="outline" className="gap-2">
                  ...
                  Notification-center-readiness workspace
                </Badge>
              ...
              >
                Notifications Center readiness
              </h1>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-semibold text-amber-100">
                Notifications Center is unavailable
              </h2>
        ...
        <Card>
          <CardHeader>
            ...
            <div className="relative max-w-xl pt-2">
              ...
              />
              <Input
                aria-label="Search Notifications Center readiness notes"
                value={query}
