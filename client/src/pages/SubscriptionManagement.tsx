...
export default function ShoppingCart() {
  ...
  return (
    ...
    >
      <ScreenHero
        icon={CartIcon}
        eyebrow="Subscription management · Billing readiness preview"
        title="Review subscription states without pretending a charge or entitlement exists."
        description="Explore a local subscription workspace with plan, subscriber identity, consent, entitlement, billing provider, payment authorization, renewal, cancellation, refund, privacy, support, save/reset, and blocked subscribe, charge, renew, cancel, refund, and export actions. No plan, subscriber, payment method, charge, entitlement, renewal, refund, payout, revenue, or customer outcome is connected."
        badge="Evidence-bounded subscription workspace"
      >
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {showGates ? "Close gates" : "Review subscription gates"}
          </Button>
          <Button
            onClick={reset}
            variant="outline"
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Subscription evidence boundary">
          <strong>
            This is a local subscription-management preview, not evidence that
            any product, inventory, price, tax, shipping rate, payment, order,
            fulfillment, refund, or customer outcome exists.
          </strong>{" "}
          Subscription concepts, local selection, saved state, consent intent,
          and disabled billing actions are browser concepts. No plan, subscriber
          identity, consent, payment authorization, charge, entitlement,
          renewal, cancellation, refund, tax, payout, revenue, or financial
          claim is asserted.
        </ScreenPreviewBanner>
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">
                  No subscription evidence loaded
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-500">
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Subscription-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real subscription surface must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Subscription-management surface preserved",
              description:
