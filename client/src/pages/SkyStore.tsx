...
export default function ShoppingCart() {
  ...
  return (
    <div data-ui-polish="batch-204" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={CartIcon}
        eyebrow="SkyStore · Commerce ecosystem preview"
        title="Explore SkyStore concepts without claiming a product or purchase exists."
        description="Explore a local SkyStore workspace with product search, catalog and seller concepts, inventory and price states, recommendations, tax/shipping concepts, save/reset, and blocked checkout/payment actions. No catalog, stock, price, tax, payment, order, fulfillment, refund, or customer outcome is connected."
        badge="Evidence-bounded SkyStore workspace"
      >
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {showGates ? "Close gates" : "Review checkout gates"}
          </Button>
          <Button
            onClick={reset}
            variant="outline"
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="SkyStore evidence boundary">
          <strong>
            This is a local SkyStore commerce-design preview, not evidence that
            any product, inventory, price, tax, shipping rate, payment, order,
            fulfillment, refund, or customer outcome exists.
          </strong>{" "}
          Product cards, quantity controls, local cart count, saved state,
          recommendations, and disabled checkout actions are browser concepts.
          No catalog, seller, stock, currency, total, discount, tax, payment
          authorization, order, shipment, refund, or financial claim is
          asserted.
        </ScreenPreviewBanner>
          ...
          <CardContent className="p-6">
            <label className="text-sm font-semibold text-slate-300">
              <span className="flex items-center gap-2">
                ...
                Search SkyStore product concepts
              </span>
              <input
                value={query}
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">
                  No SkyStore commerce evidence loaded
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  Connect verified SkyStore catalog, seller ownership,
                  inventory, currency, price, tax, shipping, payment, order,
                  fulfillment, returns, refunds, privacy, and audit before
                  checkout.
                </p>
              </div>
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              SkyStore commerce-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real SkyStore must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "SkyStore surface preserved",
              description:
              ...
              icon: CartIcon,
              status: "Local SkyStore",
            },
            {
              title: "No checkout theater",
              description:
