...
export default function ShoppingCart() {
  ...
  return (
    ...
    >
      <ScreenHero
        icon={CartIcon}
        eyebrow="Subscriber management · Membership readiness preview"
        title="Review membership states without pretending a subscription exists."
        description="Explore a local subscriber workspace with identity, consent, plan, entitlement, billing, renewal, cancellation, privacy, support, refund, save/reset, and blocked subscribe, charge, renew, cancel, and export actions. No subscriber, plan, payment method, charge, entitlement, renewal, refund, revenue, or customer outcome is connected."
        badge="Evidence-bounded subscriber workspace"
      >
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {showGates ? "Close gates" : "Review billing gates"}
          </Button>
          <Button
            onClick={reset}
            variant="outline"
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Subscriber evidence boundary">
          <strong>
            This is a local subscriber-management preview, not evidence that any
            product, inventory, price, tax, shipping rate, payment, order,
            fulfillment, refund, or customer outcome exists.
          </strong>{" "}
          Subscriber concepts, local selection, saved state, consent intent, and
          disabled billing actions are browser concepts. No subscriber identity,
          plan, consent, payment authorization, charge, entitlement, renewal,
          cancellation, refund, tax, revenue, or financial claim is asserted.
        </ScreenPreviewBanner>
