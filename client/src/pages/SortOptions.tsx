  ...
  return (
    <div data-ui-polish="batch-206" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        ...
        title="Set ordering intent without claiming a ranking result."
        description="Explore local sort preferences with deterministic options, tie-breaker intent, data-freshness disclosure, accessibility order, save/reset, and blocked personalization or recommendation actions. No catalog, feed, search result, account, engagement, price, popularity, or ranking data is connected."
        badge="Evidence-bounded sort workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Sort evidence boundary">
          <strong>
            This is a local preference-design preview, not evidence that any
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Sort-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real ordering surface must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            ...
            {
              title: "Evidence before ordering",
              description:
