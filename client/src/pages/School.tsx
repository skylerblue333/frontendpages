...
export default function School() {
  ...
  return (
    <div data-ui-polish="batch-202" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={GraduationCap}
        eyebrow="SkySchool · Education preview"
        title="Design the learning journey before issuing a credential."
        description="Explore local foundations, technology, AI, and community course concepts with search, category filters, learning-path and assessment intent, instructor, privacy, accessibility, and safeguarding gates, save/reset, and blocked enrollment/certificate actions. No course, instructor, learner, enrollment, progress, grade, rating, price, earnings, or certificate is connected."
        badge="Learning-governance workspace"
      >
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            ...
            <h2 className="mt-2 text-2xl font-black">
              What a real SkySchool system must prove
            </h2>
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
