...
const requirements: readonly Requirement[] = [
  {
    title: "Preference ownership and scope",
    area: "Integrity",
    description:
...
export default function NotificationPreferences() {
  ...
  const [status, setStatus] = useState(
    "Notification preferences are unavailable locally. No account, channel, consent, quiet-hours, subscription, or preference records were loaded or saved."
  );
        ...
        <header className="rounded-2xl border border-border/70 bg-card/80 p-6 shadow-sm sm:p-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              >
                NotificationPreferences readiness
              </h1>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground sm:text-base">
                Review preference ownership, consent, privacy, channels,
                delivery semantics, validation, feedback, and action boundaries
                without implying that accounts, subscriptions, or notification
                settings exist.
              </p>
            </div>
          ...
          <Card>
            <CardContent className="p-5">
              <BellRing
                ...
                aria-hidden="true"
              />
              <h2 className="font-semibold">No preference owner</h2>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                No account, device, workspace, category, channel, locale,
                timezone, or preference record is loaded.
              </p>
            </CardContent>
          </Card>
          <Card>
          ...
          <Card>
            <CardContent className="p-5">
              <XCircle
                ...
                aria-hidden="true"
              />
              <h2 className="font-semibold">No preference actions</h2>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
        ...
        <Card>
          <CardHeader>
            ...
            <div className="relative max-w-xl pt-2">
              ...
              />
              <Input
                aria-label="Search NotificationPreferences readiness notes"
                value={query}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                ...
                subscription, or preference record is claimed here.
              </p>
            </div>
          </div>
        </section>
