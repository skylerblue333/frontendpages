...
export default function SocialAnalytics() {
  ...
  return (
    <div data-ui-polish="batch-205" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={FileText}
        eyebrow="Social feed · Community stream preview"
        title="Explore feed states without inventing posts, authors, or engagement."
        ...
        badge="Evidence-bounded social feed workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Social feed evidence boundary">
          <strong>
          ...
          <Card className="border-white/10 bg-white/[0.04]">
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">No feed evidence loaded</p>
                <p className="mt-2 text-sm leading-6 text-slate-500">
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Feed-governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real social feed surface must prove
            </h2>
