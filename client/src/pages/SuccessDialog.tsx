...
export default function SuccessDialog() {
  ...
  return (
    <div className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={CheckCircle2}
        eyebrow="Success dialog · Result-state preview"
        title="Design confirmation without claiming an action succeeded."
        description="Review a local result-state workspace for intent, processing, verified success, failure, retry, idempotency, persistence, accessibility, privacy, and audit. No account change, payment, wallet transaction, message delivery, entitlement, upload, or business outcome is connected."
        badge="Evidence-bounded success-state workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Success-state evidence boundary">
          <strong>
            This is a local result-state design preview, not evidence that any
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            ...
            <h2 className="mt-2 text-2xl font-black">
              What a real success state must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            ...
            {
              title: "Evidence before confirmation",
              description:
