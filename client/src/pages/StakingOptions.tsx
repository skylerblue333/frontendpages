...
export default function StakingDashboard() {
  ...
  return (
    <div data-ui-polish="batch-209" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        icon={Coins}
        eyebrow="Staking options · Protocol comparison preview"
        title="Compare staking options without inventing yield, rewards, or suitability."
        ...
        badge="Evidence-bounded staking-options workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Staking-options evidence boundary">
          <strong>
            This is a read-only staking-options design preview, not evidence
            that a wallet, validator, protocol, position, balance, yield,
            reward, transaction, or financial outcome exists.
          </strong>{" "}
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">
                  No staking-option evidence loaded
                </p>
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Staking-options governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real staking-options surface must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Staking-options surface preserved",
              description:
            ...
            {
              title: "Evidence before option selection",
              description:
