...
export default function ShoppingCart() {
  ...
  return (
    ...
    >
      <ScreenHero
        icon={CartIcon}
        eyebrow="Subscriptions · Platform and creator readiness preview"
        title="Review subscription states without inventing billing or creator revenue."
        description="Explore a local platform-and-creator subscription workspace with subscriber identity, plan terms, consent, entitlement, billing provider, payment authorization, renewal, cancellation, refund, creator revenue reconciliation, privacy, support, save/reset, and blocked subscribe, charge, renew, cancel, refund, and export actions. No subscriber, plan, payment method, charge, entitlement, renewal, refund, creator payout, revenue, or customer outcome is connected."
        badge="Evidence-bounded subscriptions workspace"
      >
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {showGates ? "Close gates" : "Review subscriptions gates"}
          </Button>
          <Button
            onClick={reset}
            variant="outline"
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Subscriptions evidence boundary">
          <strong>
            This is a local subscriptions preview, not evidence that any
            product, inventory, price, tax, shipping rate, payment, order,
            fulfillment, refund, or customer outcome exists.
          </strong>{" "}
          Platform and creator subscription concepts, local selection, saved
          state, consent intent, and disabled billing actions are browser
          concepts. No subscriber identity, plan, consent, payment
          authorization, charge, entitlement, renewal, cancellation, refund,
          tax, creator payout, revenue, or financial claim is asserted.
        </ScreenPreviewBanner>
