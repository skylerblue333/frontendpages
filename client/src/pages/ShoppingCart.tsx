  ...
  return (
    <div data-ui-polish="batch-204" className="min-h-screen bg-[#070a16] text-white">
      <ScreenHero
        ...
        title="Design checkout states without inventing a purchase."
        description="Explore a local cart workspace with product search, selection, quantity, inventory and price states, recommendations, tax/shipping concepts, save/reset, and blocked checkout/payment actions. No catalog, stock, price, tax, payment, order, fulfillment, refund, or customer outcome is connected."
        badge="Evidence-bounded commerce workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Commerce evidence boundary">
          <strong>
            This is a local shopping-cart design preview, not evidence that any
