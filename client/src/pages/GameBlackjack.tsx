...
type BlackjackBoundary = { title: string; area: string; description: string };
const boundaries: readonly BlackjackBoundary[] = [
  {
  ...
  {
    title: "Server-side game state and fairness",
    area: "Integrity",
    description:
      "No server-authoritative session, deck state, randomness source, fairness proof, hand history, replay record, or dispute evidence exists.",
  },
  {
    title: "Wagers, custody, and payout accounting",
    area: "Payments",
    description:
      "No wager, wallet, balance, payment authorization, payout, fee, ledger entry, refund, or reconciliation is loaded.",
  },
  {
...
export default function GameBlackjack() {
  ...
  const [status, setStatus] = useState(
    "Blackjack is unavailable locally. No wager, game state, random outcome, balance, wallet transaction, or payout was started."
  );
  ...
  const unavailable = (action: string) =>
    setStatus(
      `${action} is unavailable locally. No wager, game state, random outcome, balance, wallet transaction, or payout was started.`
    );
  return (
    <main
      className="min-h-screen bg-background px-4 py-8 text-foreground sm:px-6 lg:px-8"
      aria-labelledby="blackjack-title"
    >
      <div className="mx-auto max-w-6xl space-y-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground sm:text-base">
                Review jurisdiction, age, fairness, custody, payout, fraud, and
                responsible-gaming boundaries without simulating a wager or game
                outcome.
              </p>
            </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-semibold text-amber-100">
                Blackjack service is unavailable
              </h2>
        ...
        <section
          ...
          aria-label="Blackjack readiness status"
        >
          <Card>
          ...
          <Card>
            <CardContent className="p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                No wager, wallet, balance, payment, payout, fee, refund, or
                financial ledger can run.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                No deck, hand, randomness, win, loss, push, payout, or fairness
                result exists.
              </p>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Blackjack-readiness map</CardTitle>
            <CardDescription>
              Search filters local boundary notes only and never starts a game,
              wager, random outcome, wallet action, or payout.
            </CardDescription>
            <div className="relative max-w-xl pt-2">
              ...
              />
              <Input
                aria-label="Search blackjack readiness notes"
                value={query}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                ...
                payouts, and independent operational acceptance.
              </p>
            </div>
          </div>
        </section>
