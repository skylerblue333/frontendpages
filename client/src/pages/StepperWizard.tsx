...
export const SignUpFlow = () => {
  ...
  return (
    ...
    >
      <ScreenHero
        icon={Sparkles}
        eyebrow="Stepper wizard · Guided workflow preview"
        title="Design a multi-step workflow without pretending it completed."
        description="Explore a local multi-step workflow across identity, preferences, security, review concepts, validation, persistence, recovery, and authorization. No account, entitlement, provider link, credential, session, or completion state is connected."
        badge="Evidence-bounded stepper workspace"
      >
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            {showGates ? "Close gates" : "Review workflow gates"}
          </Button>
          <Button
            onClick={reset}
            variant="outline"
      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Stepper evidence boundary">
          <strong>
            This is a local stepper preview, not evidence that an account,
          ...
          disabled workflow-completion actions are browser concepts. No
          scarcity, user count, review, earnings, reward, bonus, premium access,
          account, email, session, or provisioning outcome is asserted.
        </ScreenPreviewBanner>
