...
import { ArrowRight, Lightbulb, Rocket, Star } from "lucide-react";
      ...
      <section className="relative h-screen flex items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6 animate-fade-in-up">
            SKYCOIN4444: One workspace for the digital ecosystem
          </h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-up animation-delay-200">
            Explore connected experiences across AI, digital assets, education, community, and creator tools. Live balances, prices, ownership, and transaction status are shown only when the underlying integration is available.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up animation-delay-400">
            <Link href="/dashboard">
              <Button className="bg-sky-500 hover:bg-sky-600 text-white text-lg px-8 py-6 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105">
                Start Mining Now <Lightbulb className="ml-2 h-5 w-5" />
              </Button>
            </Link>
      ...
      <section className="py-20 px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="bg-gray-800 border-gray-700 text-white transform hover:scale-105 transition-transform duration-300">
            <CardHeader>
              <Lightbulb className="h-10 w-10 text-sky-400 mx-auto mb-4" />
