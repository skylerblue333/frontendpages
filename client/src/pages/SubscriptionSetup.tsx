...
export default function ShoppingCart() {
  ...
  return (
    ...
    >
      <ScreenHero
        icon={CartIcon}
        eyebrow="Subscription setup · Provider readiness preview"
        title="Review setup requirements without pretending billing is connected."
        description="Explore a local subscription-setup workspace with plan selection, subscriber identity, consent, billing provider, payment authorization, webhook reconciliation, entitlement, renewal, cancellation, refund, privacy, support, save/reset, and blocked connect, subscribe, charge, and export actions. No provider, plan, payment method, charge, entitlement, renewal, refund, payout, revenue, or payment-success outcome is connected."
        badge="Evidence-bounded subscription-setup workspace"
      >
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        />
        <ScreenPreviewBanner title="Subscription-setup evidence boundary">
          <strong>
            This is a local subscription-setup preview, not evidence that any
            product, inventory, price, tax, shipping rate, payment, order,
            fulfillment, refund, or customer outcome exists.
          </strong>{" "}
          Setup concepts, local plan selection, saved state, consent intent, and
          disabled billing actions are browser concepts. No provider, plan,
          price, currency, subscriber identity, consent, payment authorization,
          webhook, charge, entitlement, renewal, cancellation, refund, tax,
          payout, revenue, or payment-success claim is asserted.
        </ScreenPreviewBanner>
          ...
          <Card className="border-white/10 bg-white/[0.04]">
            <CardContent className="p-6">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-center">
                ...
                <p className="mt-3 font-semibold">No setup evidence loaded</p>
                <p className="mt-2 text-sm leading-6 text-slate-500">
        ...
        <Card className="border-white/10 bg-white/[0.04]">
          <CardContent className="p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-200">
              Subscription-setup governance gates
            </p>
            <h2 className="mt-2 text-2xl font-black">
              What a real subscription setup must prove
            </h2>
        ...
        <ScreenFeatureGrid
          features={[
            {
              title: "Subscription-setup surface preserved",
              description:
            ...
            {
              title: "Evidence before provider connection",
              description:
