...
ROUTES=['/portfolio-tracker','/portfolio-tracking','/power-user-tools','/predictive-models','/preferences-setup','/presentation-with-chat','/price-alerts','/pricing','/pricing-engine','/privacy-settings','/privacy-vault','/product-brain','/product-detail','/profile','/profile-completion','/profile-dashboard','/profile-edit','/profile-picture','/profile-preview','/profitability']
BASE=(sys.argv[1] if len(sys.argv)>1 else 'http://localhost:5173').rstrip('/')
OUT=ROOT/'docs/visual-review/batch-199'
...
print(json.dumps({'batch':199,'routes':len(ROUTES),'modes':['desktop','mobile']}))
