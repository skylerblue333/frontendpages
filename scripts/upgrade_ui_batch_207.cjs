...
const component = 'Sponsorships';
const marker = 'data-ui-polish="batch-207"';
...
if (!source.includes(marker)) {
  ...
  console.log(JSON.stringify({batch:207,changed:[component],routeCount:1}));
} else {
  console.log(JSON.stringify({batch:207,changed:[],routeCount:1}));
}
