...
ROUTES=['/social-feed','/social-feed-v2','/transaction-history','/translation-enabled-community','/two-factor-setup','/unhidden-mode','/unified-messaging','/unified-platform-dashboard','/user-profile','/voice-commands-registry','/walkthrough-page','/wallet-overview']
BASE=(sys.argv[1] if len(sys.argv)>1 else 'http://localhost:5173').rstrip('/')
OUT=ROOT/'docs/visual-review/batch-205'
...
print(json.dumps({'batch':205,'routes':len(ROUTES),'modes':['desktop','mobile']}))
