...
ROUTES=['/match-space','/matching-algorithm','/matchmaking','/meal-plans','/media-carousel','/media-gallery','/medication-reminder','/mega-marketplace','/memory-system','/mentions','/milestone-tracking','/mining-calculator','/mining-dashboard','/mining-pool-selector','/mobile-app','/mobile-gaming','/mobile-home','/mobile-menu','/mobile-notifications','/mobile-profile']
BASE=(sys.argv[1] if len(sys.argv)>1 else 'http://localhost:5173').rstrip('/')
OUT=ROOT/'docs/visual-review/batch-195'
...
print(json.dumps({'batch':195,'routes':len(ROUTES),'modes':['desktop','mobile']}))
