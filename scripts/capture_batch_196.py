...
ROUTES=['/mobile-search','/mobile-settings','/mobile-streaming','/mobile-trading','/mobile-wallet','/moderation-dashboard','/monetization','/mood-tracker','/movie-catalog','/movie-detail','/multi-model-selector','/multi-select-form','/multiplayer-lobby','/multivariate-testing','/mutual-connections','/mutual-friends','/my-learning','/my-trips','/n-f-t-gallery','/n-f-t-minting']
BASE=(sys.argv[1] if len(sys.argv)>1 else 'http://localhost:5173').rstrip('/')
OUT=ROOT/'docs/visual-review/batch-196'
...
print(json.dumps({'batch':196,'routes':len(ROUTES),'modes':['desktop','mobile']}))
