...
const routes = ['SocialMediaCampaigns','SortOptions'];
const marker = 'data-ui-polish="batch-206"';
const changed=[];
...
console.log(JSON.stringify({batch:206,changed,routeCount:routes.length}));
