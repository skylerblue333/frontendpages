...
**Portfolio — `/portfolio`**. Exchange was modernized as a partial checkpoint at its actual registered route, `/crypto-exchange`; the requested `/exchange` alias remains unregistered and is not being presented as available.
